export default function WhatsAppButton() {
    return (
      <a href="https://wa.me/50600000000" target="_blank" className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-400 rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:scale-110 group">
